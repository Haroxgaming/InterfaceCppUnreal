...
void ATestCppUnrealCharacter::ReactToTrigger()
{
	...
	if(GetWorld()->LineTraceSingleByChannel(HitResult, TraceStart, TraceEnd, ECC_Visibility, Params))
	{
		...
		{
			if(IReactToTriggerinterface* ReactToTriggerinterface = Cast<IReactToTriggerinterface>(HitResult.GetActor()))
			{
				ReactToTriggerinterface->testinterfacecall();
			}
		}
	}
